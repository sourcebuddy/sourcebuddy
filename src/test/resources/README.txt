The files in this directory support tests.
The directory `source_tree` contains Java source files.
It is used to test that the library works well, slurping up source files from a directory.
