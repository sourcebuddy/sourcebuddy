...
== Introduction
.This documentation is about the version 2.5.0-SNAPSHOT of the software.
...
NOTE: The `getBinaryName()` implementation supports JVM byte code up to 65, which is Java 20.
