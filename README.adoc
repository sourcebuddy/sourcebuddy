...
== Introduction
.This documentation is about the version 2.2.1-SNAPSHOT of the software.
...
NOTE: The `getBinaryName()` implementation supports JVM byte code up to 64, which is Java 20.
